...
PICS = (environ.get('PICS' ,'https://graph.org/file/8632d99951073c48258f7.jpg https://graph.org/file/4d6c30a553a51cab1a2b9.jpg https://graph.org/file/550a86ff61f7decaf3696.jpg https://graph.org/file/b8efce0a040d28123028e.jpg')).split()
BOT_START_TIME = time()
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Movies10xSearch')
...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Query: {query}</b> \n‌IMDb Data:\n\n🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a> / 10\n\n<b>𝙿𝙻𝙴𝙰𝚂𝙴 𝙹𝙾𝙸𝙽 👉🏻 [𝙽𝙴𝚃𝚆𝙾𝚁𝙺𝟷𝟶𝚇 𝙾𝙵𝙵𝙸𝙲𝙸𝙰𝙻](https://t.me/Network10xOfficial)</b>")
